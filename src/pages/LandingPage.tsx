...
const DEMO_CREDENTIALS = {
  student: { id: 'S12345', password: 'student123' },
  ...
  const demoOptions = [
    {
      ...
      credentials: DEMO_CREDENTIALS.student,
      path: '/student'
    },
    {
      title: 'Teacher Demo',
      ...
      credentials: DEMO_CREDENTIALS.teacher,
      path: '/teacher'
    },
    {
      ...
      credentials: { id: 'dev', password: 'dev123' },
      path: '/teacher'
    }
  ];

  const handleDemoClick = (credentials: { id: string; password: string }, path: string) => {
            ...
            {demoOptions.map((option, index) => (
              <Grid item xs={12} md={4} key={index}>
                <Card 
                  ...
                  onClick={() => handleDemoClick(option.credentials, option.path)}
                >
                  <CardContent sx={{ 
                    textAlign: 'center',
                    height: '100%',
